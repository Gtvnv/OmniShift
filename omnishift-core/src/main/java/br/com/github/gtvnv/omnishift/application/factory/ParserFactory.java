...
public class ParserFactory {
    ...
    /**
     * Descobre automaticamente todas as implementações de DataParser disponíveis
     * no classpath via Java SPI (arquivos META-INF/services), sem depender de
     * um container de injeção de dependência.
     */
    public static ParserFactory discover() {
        List<DataParser> parsers = ServiceLoader.load(DataParser.class).stream()
